...
> **实现进度：** **P0–P5 已落地**（RawDataSourceManager、Memory/Graph JSONL、pending-index、LLM 抽取 + pending-reextract、桌面/移动图管理页、`recall_relations`、集合类行级 LWW）；K1 知识库未开工。
...
| P3 ✅ | 图管理页（桌面 d3-force；移动搜索/待重抽/待确认） | 看得见、管得着 |
