...
describe('batch embed control', () => {
  it('should treat checkpoint as ok when no session is active', async () => {
    await expect(checkpointBatchEmbed()).resolves.toBe('ok')
    expect(isBatchEmbedPaused()).toBe(false)
  })

  it('should hold checkpoint until resume when paused', async () => {
    beginBatchEmbedControl()
    requestBatchEmbedPause()
  ...
  it('should wake a paused checkpoint as aborted when cancelled', async () => {
    beginBatchEmbedControl()
    requestBatchEmbedPause()
  ...
  it('should apply a pause requested before the session starts', async () => {
    requestBatchEmbedPause()
    expect(isBatchEmbedPaused()).toBe(true)
    beginBatchEmbedControl()
    expect(isBatchEmbedPaused()).toBe(true)
  ...
  it('should apply a cancel requested before the session starts', async () => {
    requestBatchEmbedCancel()
    beginBatchEmbedControl()
